  ...
  return (
    <>
      <div className="flex flex-col flex-auto">
        <div className="flex flex-auto flex-col max-w-full">
          <div className="flex flex-row lg:flex-row items-center justify-between lg:justify-center gap-2 lg:gap-9 bg-gradient-to-b from-blue-600 to-indigo-700 sm:min-h-24 min-h-14 shadow-xl px-4 py-3">
            ...
            <div className="w-full sm:w-auto">
              <button
                className="sm:py-2 sm:px-4 px-1 py-1 text-sm sm:text-lg bg-gradient-to-br from-lime-500 to-green-500 hover:from-lime-600 hover:to-green-600 text-white font-semibold rounded cursor-pointer w-25 sm:w-auto"
                onClick={() => {
        ...
        <div className="min-h-screen flex flex-col px-4 sm:px-6 lg:pl-46 pt-4 pb-30 bg-gradient-to-br gap-10 from-blue-200 to-indigo-100">
          <div className="shadow-[0_2px_20px_rgba(0,0,0,0.1)] bg-gradient-to-r from-blue-100 to-gray-50 max-w-6xl flex flex-col mt-6 rounded-xl">
            <div className="text-3xl sm:text-4xl lg:text-5xl font-semibold p-6 sm:p-10 lg:p-12">
            ...
            <div className="rounded-lg px-6 sm:px-10 pb-10 pt-2">
          ...
          <div className="flex flex-col max-w-6xl">
            <div className="my-3 flex flex-col">
              <h2 className="text-3xl sm:text-4xl font-bold mb-3 ml-1">
                Top Talent for you
              </h2>
              ...
              <button
                className="bg-blue-500 text-white mx-auto lg:ml-130 px-4 py-2 max-w-28 rounded-lg flex items-center justify-center gap-2 hover:bg-blue-600 text-lg text-center font-semibold mt-12 cursor-pointer"
