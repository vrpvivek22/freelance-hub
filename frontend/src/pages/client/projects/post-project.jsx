import createClientProjectApi from "@/services/client/project";
...
function PostAProject() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await createClientProjectApi(body);
      alert(res.message);
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-100 py-10">
        <form
          ...
          className="  max-w-4xl mx-auto p-10 space-y-6 rounded-2xl shadow-xl bg-white "
        >
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-row items-center justify-between">
              ...
              <div>
                <button
                  type="submit"
                  className="font-semibold bg-blue-500 hover:bg-blue-600 cursor-pointer text-white px-8 py-2 mt-7 rounded"
                >
                  Post
                </button>
              </div>
