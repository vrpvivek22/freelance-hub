...
function ClientDetailsPanel() {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row items-start justify-center gap-4 pt-4 pb-30 bg-gradient-to-br from-blue-100 to-indigo-100 px-3 sm:px-6 lg:px-0">
        <div className="flex flex-col relative w-full lg:w-[890px] rounded-b-sm space-y-4">
          <div className="flex flex-col sm:flex-row relative rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.1)] p-4 sm:p-6 bg-blue-50">
            <img
              src={details.profileImage || "/default-avatar.png"}
              alt="Profile"
              className="w-32 h-32 sm:w-44 sm:h-44 object-cover rounded-xl sm:mr-6 shadow-md p-1 bg-gradient-to-br from-blue-400 to-indigo-400 self-center sm:self-start"
            />
            <div className="flex flex-col justify-center space-y-1 mt-4 sm:mt-0">
              <p className="font-bold text-2xl sm:text-4xl text-center sm:text-left">
                {details.name}
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start">
                <p className="flex items-center gap-1 mb-2">
                  ...
                  <span className="ml-2 mt-1.5 font-semibold text-xl sm:text-2xl">
                    {details.averageRating
                      ? Number(details.averageRating).toFixed(1)
                      : "0.0"}
                  </span>
                </p>
                <p className="flex sm:-mt-0.5">
                  <span className="ml-3 mr-1 text-2xl sm:text-3xl opacity-85">
                    💬
                  </span>
                  <span className="text-xl sm:text-2xl mt-0.5 font-semibold">
                    {details.totalReviews ? Number(details.totalReviews) : "0"}
                  </span>
                </p>
              </div>

              <div className="flex flex-wrap justify-center sm:justify-start ml-1 text-gray-700 text-sm sm:text-base gap-y-1">
          ...
          <button
            ...
            onClick={handleEdit}
          >
            <FaEdit className="hover:text-gray-700 hover:scale-105 text-gray-500 cursor-pointer font-semibold text-xl sm:text-2xl transition" />
          </button>

          <div className="py-6 sm:py-8 px-5 sm:px-7 space-y-4 rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.1)] p-6 bg-blue-50">
          ...
          <div className="rounded-xl space-y-6 shadow-[0_0_10px_rgba(0,0,0,0.1)] px-4 sm:px-6 py-6 sm:py-8 bg-blue-50">
            <h2 className="flex flex-row items-center flex-wrap">
              <p className="text-3xl sm:text-4xl font-bold ml-2">Reviews</p>{" "}
            ...
            {reviews && reviews.length > 0 ? (
              <div className="space-y-3 sm:pr-8 pl-2">
                {reviews.slice(0, visibleCount).map((rev) => (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row justify-between space-x-3">
                      <div className="flex flex-row space-x-4 items-center">
                        ...
                        <div className="flex flex-col">
                          <div className="flex flex-row gap-4 sm:gap-6 items-center flex-wrap">
                    ...
                    <p className="text-gray-800 mt-2 ml-2 text-sm sm:text-base">
                      {rev.reviewText}
                    </p>
                  </div>
                ))}
              ...
              <p className="text-gray-600 ml-3 text-lg sm:text-xl mb-10">
                No reviews yet.
              </p>
            )}
          </div>
        ...
        <div className="flex flex-col sticky top-2 bg-blue-50 px-4 py-8 sm:py-10 rounded-xl space-y-3 shadow-[0_0_10px_rgba(0,0,0,0.1)] w-full sm:w-[300px] lg:w-[245px]">
          <div className="flex flex-row text-base sm:text-lg justify-between">
            Open projects
