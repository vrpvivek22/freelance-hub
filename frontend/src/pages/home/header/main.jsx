...
function Header() {
  ...
  return (
    <div className="top-0 sticky flex justify-between px-35 w-full h-22 bg-black/40 backdrop-blur-sm z-20">
      <div className="flex flex-row items-center">
        <FaLaptop className="text-5xl mt-1 text-amber-500" />
        <h1 className=" text-white text-3xl ml-2 mr-5 logo-text">
          FreelanceHub
        </h1>
        <div
      ...
      <div className="flex flex-row items-center">
        ...
        <Link
          ...
          className="text-white cursor-pointer px-4 py-2 bg-blue-600 rounded ml-5 hover:bg-blue-800 hover:border-none"
        >
          Sign Up
        </Link>
      </div>
