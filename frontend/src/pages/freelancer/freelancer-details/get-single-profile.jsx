...
function FreelancerSingleProfile() {
  const { id } = useParams();
  ...
  return (
    <>
      <div className="flex flex-row justify-center gap-4 pt-4 pb-30 items-start bg-gradient-to-br from-blue-100 to-indigo-100">
        <div className="flex flex-col w-[895px] rounded-b-sm space-y-4">
          <div className="flex flex-row rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.1)] p-6 bg-blue-50">
            <img
              ...
              alt="Profile"
              className="w-48 h-48 object-cover rounded-xl mr-6 shadow-md p-1 bg-gradient-to-br from-blue-400 to-indigo-400"
            />
                    ...
                    <div className="flex flex-row justify-between space-x-3">
                      <div className="flex flex-row space-x-4 items-center">
                        <img
                          ...
                          alt="Freelancer"
                          className="w-17 h-17 mt-2 rounded-xl object-cover border"
                        />
...
export default FreelancerSingleProfile;
